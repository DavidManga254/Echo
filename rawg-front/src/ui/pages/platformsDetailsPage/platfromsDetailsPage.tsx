...
import { getAllGamesByPlatform, getNextPageByPlatform } from './platformDetailsPageModel';
export function PlatformsDetailsPage() {
    ...
    useEffect(() => {
        (async () => {
            const response = await getAllGamesByPlatform(platformSlug as string, 1);
